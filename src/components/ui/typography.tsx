...
>((props, ref) => {
	return (
		<h2
			{...props}
			ref={ref}
			className={cn('scroll-m-20 text-3xl font-semibold ', props.className)}
		>
			{props.children}
		</h2>
	)
...
>((props, ref) => {
	return (
		<h4
			{...props}
			ref={ref}
			className={cn('scroll-m-20 text-xl font-semibold', props.className)}
		>
			{props.children}
		</h4>
	)
...
>((props, ref) => {
	return (
		<p {...props} ref={ref} className={cn('', props.className)}>
			{props.children}
		</p>
	)
})
